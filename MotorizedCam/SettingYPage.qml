...
Rectangle
{
    ...
    Rectangle
    {
        ...
        SliderParameter
        {
            ...
            onSendParameter:
            {
                stepperY.ThresholdSpeed = paramValue;
            }
        }
        ...
        SliderParameter
        {
            ...
            onSendParameter:
            {
                stepperY.Acceleration = paramValue;
            }
        }
        ...
        SliderParameter
        {
            ...
            onSendParameter:
            {
                stepperY.Deceleration = paramValue;
            }
        }
    ...
    Rectangle
    {
        ...
        RadioButton
        {
            ...
            onSendParameter:
            {
                ...
                stepperY.StepMode = stepMODE_FULL_STEP;
            }
        ...
        RadioButton
        {
            ...
            onSendParameter:
            {
                ...
                rbStpMode64uStep.active = false;
                rbStpMode128uStep.active = false;
                stepperY.StepMode = stepMODE_HALF_STEP;
            }
        }
        ...
        RadioButton
        {
            ...
            onSendParameter:
            {
                ...
                rbStpMode64uStep.active = false;
                rbStpMode128uStep.active = false;
                stepperY.StepMode = stepMODE_uSTEP_4;
            }
        }
        ...
        RadioButton
        {
            ...
            onSendParameter:
            {
                ...
                rbStpMode64uStep.active = false;
                rbStpMode128uStep.active = false;
                stepperY.StepMode = stepMODE_uSTEP_8;
            }
        }
        ...
        RadioButton
        {
            ...
            onSendParameter:
            {
                ...
                rbStpMode64uStep.active = false;
                rbStpMode128uStep.active = false;
                stepperY.StepMode = stepMODE_uSTEP_16;
            }
        }
        ...
        RadioButton
        {
            ...
            onSendParameter:
            {
                ...
                rbStpMode64uStep.active = false;
                rbStpMode128uStep.active = false;
                stepperY.StepMode = stepMODE_uSTEP_32;
            }
        }
        ...
        RadioButton
        {
            ...
            onSendParameter:
            {
                ...
                rbStpMode128uStep.active = false;
                stepperY.StepMode = stepMODE_uSTEP_64;
            }
        }
        ...
        RadioButton
        {
            ...
            onSendParameter:
            {
                ...
                stepperY.StepMode = stepMODE_uSTEP_128;
            }
        }
    ...
    Connections
    {
        ...
        onMaxSpeedChanged:
        {
            param_maxSpeed.paramValue = stepperY.MaxSpeed;
        }

        onThresholdSpeedChanged:
        {
            param_thrSpeed.paramValue = stepperY.ThresholdSpeed;
        }

        onAccelerationChanged:
        {
            param_acceleration.paramValue = stepperY.Acceleration;
        }

        onDecelerationChanged:
        {
            param_deceleration.paramValue = stepperY.Deceleration;
        }

        onKValHoldChanged:
        {
            param_holdTorque.paramValue = stepperY.KValHold;
        }

        onKValAccChanged:
        {
            param_accTorque.paramValue = stepperY.KValAcc;
        }

        onKValRunChanged:
        {
            param_runTorque.paramValue = stepperY.KValRun;
        }

        onKValDecChanged:
        {
            param_decTorque.paramValue = stepperY.KValDec;
        }

        onStepModeChanged:
        {
            switch(stepperY.StepMode)
            {
